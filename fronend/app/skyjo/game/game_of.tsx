...
export default function GameOf() {
  ...
  const { cardsClick, room, Allplayers, gameOvrer ,name_player, name_of_turn, click_card_in_table, click_random_card_in_table, remove_random_card_in_table, last_turn, first_hrade_cards ,all_first_hrade_cards,final_turn_Results} = useSocket();
  ...
  // Function to rearrange players with current player at index 0 (Clash Royale style)
      ...
      <div className="relative w-full h-screen">
          ...
          {final_turn_Results && (
            <ResultsPopup
              ...
              onClose={() => {setShowResultsPopup(false);if(gameOvrer){ router.push('/');router.refresh};}}
